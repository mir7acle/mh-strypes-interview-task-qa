...
public class StrypesTestBasic {
	...
	@BeforeClass
	public void prepareTestBasic() {
		
		System.out.println("Hi");
		
		wdm = new WebDriverManager("chrome");
	...
	@Test
	public void tcOpenHomePageSlideFirst() {
	...
	@Test
	public void tcSlideNavRightNarrow() {
	...
	@Test
	public void tcSlideNavLeftNarrow() {
		System.out.println("\n--- Test case 4 ---\n");
...
//		System.out.println(Left: "Current slide: " + indexCurrentSlide + "\nAfter Left narrow slide: " + indexLeftSlide);
	...
	@Test
	public void tcSlilePaginationNav() {
	...
	@Test
	public void tcPagBulletsEqualToSlideCount() {
